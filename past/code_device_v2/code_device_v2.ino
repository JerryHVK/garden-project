...
void setup() {
  ...
  /*
  if you declare the pubTopic here, after the function "setup" finished,
  pubTopic will be deleted, then the pointer pub_topic will point to anything else but not pubTopic, 
  it may point to null
  That's the reason why i declare it as a global variable
  */
  // String pubTopic = "device/"; 
  // String pubTopic = "";
  pubTopic += "device/";
  pubTopic += GARDEN_ID;
  pubTopic += "/data";

  // String subTopic = "device/";
  // String subTopic = "";
  subTopic += "device/";
  subTopic += GARDEN_ID;
  subTopic += "/control";
